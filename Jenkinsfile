...
properties([parameters([[$class: 'ChoiceParameter', choiceType: 'PT_CHECKBOX', description: 'What to build?', filterLength: 1, filterable: false, name: 'what_to_build', randomName: 'choice-parameter-3501156088772411', script: [$class: 'GroovyScript', fallbackScript: [classpath: [], sandbox: false, script: ''], script: [classpath: [], sandbox: true, script: 'return [\'binaries\', \'bindings\']']]], [$class: 'CascadeChoiceParameter', choiceType: 'PT_SINGLE_SELECT', description: '', filterLength: 1, filterable: false, name: 'binaries_build_type', randomName: 'choice-parameter-3501156094468540', referencedParameters: 'what_to_build', script: [$class: 'GroovyScript', fallbackScript: [classpath: [], sandbox: false, script: ''], script: [classpath: [], sandbox: false, script: '''if(what_to_build.contains(\'binaries\')) {
  return  [\'Debug\', \'Release\']
}
else { return \'\' }''']]], [$class: 'CascadeChoiceParameter', choiceType: 'PT_CHECKBOX', description: '', filterLength: 1, filterable: false, name: 'binaries_platforms', randomName: 'choice-parameter-3501156100518368', referencedParameters: 'what_to_build', script: [$class: 'GroovyScript', fallbackScript: [classpath: [], sandbox: false, script: ''], script: [classpath: [], sandbox: false, script: '''if(what_to_build.contains(\'binaries\')) {
  return [\'x86_64-linux-gnu\', \'aarch64-linux-gnu\', \'arm-linux-gnueabihf\', \'x86_64-apple-darwin16\']
}
''']]], [$class: 'CascadeChoiceParameter', choiceType: 'PT_CHECKBOX', description: '', filterLength: 1, filterable: false, name: 'bindings_type', randomName: 'choice-parameter-3501156106888187', referencedParameters: 'what_to_build', script: [$class: 'GroovyScript', fallbackScript: [classpath: [], sandbox: false, script: ''], script: [classpath: [], sandbox: false, script: 'return [\'Python2\', \'Python3\', \'Java\', \'Android\']']]], [$class: 'CascadeChoiceParameter', choiceType: 'PT_SINGLE_SELECT', description: '', filterLength: 1, filterable: false, name: 'bindings_build_type', randomName: 'choice-parameter-3501156112887564', referencedParameters: 'what_to_build', script: [$class: 'GroovyScript', fallbackScript: [classpath: [], sandbox: false, script: ''], script: [classpath: [], sandbox: false, script: '''if(what_to_build.contains(\'bindings\')) {
  return  [\'Debug\', \'Release\']
}''']]], [$class: 'CascadeChoiceParameter', choiceType: 'PT_CHECKBOX', description: '', filterLength: 1, filterable: false, name: 'bindings_platforms', randomName: 'choice-parameter-3501156119893785', referencedParameters: 'what_to_build', script: [$class: 'GroovyScript', fallbackScript: [classpath: [], sandbox: false, script: ''], script: [classpath: [], sandbox: false, script: '''if(what_to_build.contains(\'bindings\') && (bindings_type != [\'Android\'])) {
  return [\'x86_64-linux-gnu\', \'aarch64-linux-gnu\', \'arm-linux-gnueabihf\', \'x86_64-apple-darwin16\', \'x86_64-windows\']
}''']]], [$class: 'CascadeChoiceParameter', choiceType: 'PT_MULTI_SELECT', description: '', filterLength: 1, filterable: false, name: 'android_bindings_platforms', randomName: 'choice-parameter-3501156124636671', referencedParameters: 'bindings_type', script: [$class: 'GroovyScript', fallbackScript: [classpath: [], sandbox: false, script: ''], script: [classpath: [], sandbox: false, script: '''if(bindings_type.contains(\'Android\')) {
  return [\'arm64-v8a\', \'armeabi-v7a\', \'armeabi\', \'x86_64\', \'x86\']
}''']]], [$class: 'CascadeChoiceParameter', choiceType: 'PT_SINGLE_SELECT', description: '', filterLength: 1, filterable: false, name: 'android_bindings_abi', randomName: 'choice-parameter-3501156128757891', referencedParameters: 'bindings_type', script: [$class: 'GroovyScript', fallbackScript: [classpath: [], sandbox: false, script: ''], script: [classpath: [], sandbox: false, script: '''if(bindings_type.contains(\'Android\')) {
