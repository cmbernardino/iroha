...
properties([parameters([[$class: 'ChoiceParameter', choiceType: 'PT_CHECKBOX', description: 'What to build?', filterLength: 1, filterable: false, name: 'what_to_build', randomName: 'choice-parameter-3496033513873330', script: [$class: 'GroovyScript', fallbackScript: [classpath: [], sandbox: false, script: ''], script: [classpath: [], sandbox: true, script: 'return [\'binaries\', \'bindings\']']]], [$class: 'CascadeChoiceParameter', choiceType: 'PT_CHECKBOX', description: 'Choose what to build', filterLength: 1, filterable: false, name: 'build_components', randomName: 'choice-parameter-3496033521202996', referencedParameters: 'what_to_build', script: [$class: 'GroovyScript', fallbackScript: [classpath: [], sandbox: true, script: 'return \'Debug\''], script: [classpath: [], sandbox: false, script: '''if(what_to_build.equals(\'binaries\')) {
return what_to_build.getClass()
}''']]], [$class: 'CascadeChoiceParameter', choiceType: 'PT_SINGLE_SELECT', description: 'Python bindings build type', filterLength: 1, filterable: false, name: 'PBBuildType', randomName: 'choice-parameter-3496033525988159', referencedParameters: 'PythonBindings', script: [$class: 'GroovyScript', fallbackScript: [classpath: [], sandbox: false, script: 'return [\'Debug\']'], script: [classpath: [], sandbox: false, script: 'return [\'Debug\', \'Release\']']]]])])
