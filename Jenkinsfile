...
properties([parameters([[$class: 'ChoiceParameter', choiceType: 'PT_CHECKBOX', description: 'What to build?', filterLength: 1, filterable: false, name: 'what_to_build', randomName: 'choice-parameter-3498708492360000', script: [$class: 'GroovyScript', fallbackScript: [classpath: [], sandbox: false, script: ''], script: [classpath: [], sandbox: true, script: 'return [\'binaries\', \'bindings\']']]], [$class: 'CascadeChoiceParameter', choiceType: 'PT_SINGLE_SELECT', description: '', filterLength: 1, filterable: false, name: 'binaries_build_type', randomName: 'choice-parameter-3498708498260309', referencedParameters: 'what_to_build', script: [$class: 'GroovyScript', fallbackScript: [classpath: [], sandbox: false, script: ''], script: [classpath: [], sandbox: false, script: '''if(what_to_build.contains(\'binaries\')) {
  return  [\'Debug\', \'Release\']
}''']]], [$class: 'CascadeChoiceParameter', choiceType: 'PT_CHECKBOX', description: '', filterLength: 1, filterable: false, name: 'binaries_platforms', randomName: 'choice-parameter-3498708504449943', referencedParameters: 'what_to_build', script: [$class: 'GroovyScript', fallbackScript: [classpath: [], sandbox: false, script: ''], script: [classpath: [], sandbox: false, script: '''if(what_to_build.contains(\'binaries\')) {
  return [\'x86_64-linux-gnu\', \'aarch64-linux-gnu\', \'arm-linux-gnueabihf\', \'x86_64-apple-darwin16\']
}
''']]], [$class: 'CascadeChoiceParameter', choiceType: 'PT_SINGLE_SELECT', description: '', filterLength: 1, filterable: false, name: 'bindings_build_type', randomName: 'choice-parameter-3498708510136991', referencedParameters: 'what_to_build', script: [$class: 'GroovyScript', fallbackScript: [classpath: [], sandbox: false, script: ''], script: [classpath: [], sandbox: false, script: '''if(what_to_build.contains(\'bindings\')) {
  return  [\'Debug\', \'Release\']
}''']]], [$class: 'CascadeChoiceParameter', choiceType: 'PT_CHECKBOX', description: '', filterLength: 1, filterable: false, name: 'bindings_platforms', randomName: 'choice-parameter-3498708516202133', referencedParameters: 'what_to_build', script: [$class: 'GroovyScript', fallbackScript: [classpath: [], sandbox: false, script: ''], script: [classpath: [], sandbox: false, script: '''if(what_to_build.contains(\'bindings\')) {
  return [\'x86_64-linux-gnu\', \'aarch64-linux-gnu\', \'arm-linux-gnueabihf\', \'x86_64-apple-darwin16\', \'x86_64-windows\']
}''']]], [$class: 'CascadeChoiceParameter', choiceType: 'PT_CHECKBOX', description: '', filterLength: 1, filterable: false, name: 'bindings_type', randomName: 'choice-parameter-3498708521832543', referencedParameters: 'what_to_build', script: [$class: 'GroovyScript', fallbackScript: [classpath: [], sandbox: false, script: ''], script: [classpath: [], sandbox: false, script: 'return [\'Python2\', \'Python3\', \'Java\', \'Android\']']]], [$class: 'CascadeChoiceParameter', choiceType: 'PT_MULTI_SELECT', description: '', filterLength: 1, filterable: false, name: 'android_bindings_platforms', randomName: 'choice-parameter-3498708530824797', referencedParameters: 'bindings_type', script: [$class: 'GroovyScript', fallbackScript: [classpath: [], sandbox: false, script: ''], script: [classpath: [], sandbox: false, script: '''if(bindings_type.contains(\'Android\')) {
  return [\'arm64-v8a\', \'armeabi-v7a\', \'armeabi\', \'x86_64\', \'x86\']
}''']]], [$class: 'CascadeChoiceParameter', choiceType: 'PT_SINGLE_SELECT', description: '', filterLength: 1, filterable: false, name: 'android_bindings_abi', randomName: 'choice-parameter-3498708538810348', referencedParameters: 'bindings_type', script: [$class: 'GroovyScript', fallbackScript: [classpath: [], sandbox: false, script: ''], script: [classpath: [], sandbox: false, script: '''if(bindings_type.contains(\'Android\')) {
  return [26..14]
}''']]]])])
